<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="slider-area">
    ...
    <div class="block-slider block-slider4">
        <ul class="" id="bxslider-home4">
            <li>
                <img src="/rest/site/img/h4-slide.png" alt="Slide">
            ...
            <li><img src="/rest/site/img/h4-slide2.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
            ...
            <li><img src="/rest/site/img/h4-slide3.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
            ...
            <li><img src="/rest/site/img/h4-slide4.png" alt="Slide">
                <div class="caption-group">
                  <h2 class="caption title">
                        Apple <span class="primary">Store <strong>Ipod</strong></span>
                    </h2>
                ...
                <div class="product-carousel">
                    <div class="single-product">
                        <div class="product-f-image">
                            <img src="/rest/site/img/product-1.jpg" alt="">
                    ...
                    <div class="single-product">
                        <div class="product-f-image">
                            <img src="/rest/site/img/product-2.jpg" alt="">
                            <div class="product-hover">
                                <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                            </div>
                    ...
                    <div class="single-product">
                        <div class="product-f-image">
                            <img src="/rest/site/img/product-3.jpg" alt="">
                            <div class="product-hover">
                                <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                            </div>
                    ...
                    <div class="single-product">
                        <div class="product-f-image">
                            <img src="/rest/site/img/product-4.jpg" alt="">
                            <div class="product-hover">
                                <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                            </div>
                    ...
                    <div class="single-product">
                        <div class="product-f-image">
                            <img src="/rest/site/img/product-5.jpg" alt="">
                            <div class="product-hover">
                                <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                            </div>
                    ...
                    <div class="single-product">
                        <div class="product-f-image">
                            <img src="/rest/site/img/product-6.jpg" alt="">
                            <div class="product-hover">
                                <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                            </div>
        ...
        <div class="col-md-12">
            <div class="brand-wrapper">
                <div class="brand-list">
                    <img src="/rest/site/img/brand1.png" alt="">
                    <img src="/rest/site/img/brand2.png" alt="">
                    <img src="/rest/site/img/brand3.png" alt="">
                    <img src="/rest/site/img/brand4.png" alt="">
                    <img src="/rest/site/img/brand5.png" alt="">
                    <img src="/rest/site/img/brand6.png" alt="">
                    <img src="/rest/site/img/brand1.png" alt="">
                    <img src="/rest/site/img/brand2.png" alt="">                            
                </div>
            </div>
